...
sonucu oluşan bir sayı dizisidir. Bu şekilde devam eden bu dizide sayılar
birbirleriyle oranlandığında altın oran ortaya çıkar, yani bir sayı kendisinden
önceki sayıya bölündüğünde altın orana gittikçe yaklaşan bir dizi elde edilir.

Fibonacci dizisi, 0'dan başlar ve sonsuza kadar. Her rakam, bir önceki rakamla
toplanır. Elde edilen sonuç rakamın sağ tarafına yazılır. Fibonacci dizisinin ilk on
...
public class Fibonacci {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("fibonaccinin kac elemanini istiyorsunuz: ");
        int index = inp.nextInt();
        int i = 1;
        while(i <= index) {
            System.out.print(" " + ft_fibonacci(i));
            i++;
        }
    }
}
